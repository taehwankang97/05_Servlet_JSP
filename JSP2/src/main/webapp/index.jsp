...
<body>
  <pre>
    ...
    index.jsp가 변호나 된 index_jsp.clss 파일로 요청이 매칭
  ...
  <h1>EL (Expression Languguage, 표현 언어 )</h1>
...
<%-- form 태그 method 기본값은 get --%>
  ...
  <h1>
    <a href="/el/scope">
    Servlet/JSP 범위(scop)별 내장 객체 + EL 사용법
    </a>
  </h1>
