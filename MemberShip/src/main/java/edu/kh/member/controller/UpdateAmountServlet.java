...
public class UpdateAmountServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			switch(result) {
			case 5 : message = "금액이 변경 되었습니다"; break;
			case 0 : message = "등급이 [일반]으로 변경 되었습니다"; break;
			case 1 : message = "등급이 [실버]으로 변경 되었습니다"; break;
			case 2 : message = "등급이 [골드]로 변경 되었습니다"; break;
			case 3 : message = "등급이 [백금]으로 변경 되었습니다"; break;
			case 4 : message = "등급이 [다이아몬드]로 변경 되었습니다"; break;
			}
